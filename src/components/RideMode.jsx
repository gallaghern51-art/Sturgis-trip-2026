...
const NAV_AHEAD = '#ffb03a';
const NAV_DONE = 'rgba(150, 155, 162, 0.72)';
...
function ensureNavLayers(map) {
  ...
  map.addLayer({ id: 'ride-route-glow', type: 'line', source: 'ride-route', paint: { 'line-color': '#e8622c', 'line-width': 14, 'line-opacity': 0.3, 'line-blur': 4 }, layout: round });
  map.addLayer({ id: 'ride-route-casing', type: 'line', source: 'ride-route', paint: { 'line-color': '#14100b', 'line-width': 9.5, 'line-opacity': 0.85 }, layout: round });
  ...
  map.addLayer({ id: 'ride-live-casing', type: 'line', source: 'ride-live', paint: { 'line-color': '#14100b', 'line-width': 9.5, 'line-opacity': 0.85 }, layout: round });
